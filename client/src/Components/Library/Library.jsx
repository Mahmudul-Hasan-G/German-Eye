...
const Library = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className="grid grid-cols-3 justify-items-center gap-12 py-12 bg-cover" style={{ backgroundImage: `url(/lib.webp)` }}>
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
          ...
          <div className="card-body items-center text-center">
            ...
            <div className="card-actions">
              <button onClick={() => handleClick("/public/trc.pdf", "/trc.webp")}
                className="btn btn-accent"
              >
                Read me now!
              </button>
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
          ...
          <div className="card-body items-center text-center">
            ...
            <div className="card-actions">
              <button onClick={() => handleClick("/public/ar.pdf", "/ar.jpg")}
                className="btn btn-accent">
                Read me now!
              </button>
            </div>
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
          ...
          <div className="card-body items-center text-center">
            ...
            <div className="card-actions">
              <button onClick={() => handleClick("/public/365.pdf", "/365.jpg")}
                className="btn btn-accent">
                Read me now!
              </button>
            </div>
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
          ...
          <div className="card-body items-center text-center">
            ...
            <div className="card-actions">
              <button onClick={() => handleClick("/public/wiw.pdf", "/wiw.jpg")}
                className="btn btn-accent">
                Read me now!
              </button>
            </div>
